...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy.setHeightForWidth(layoutStartMain->sizePolicy().hasHeightForWidth());
        layoutStartMain->setSizePolicy(sizePolicy);
        ...
        frame->setGeometry(QRect(-100, 20, 1281, 661));
        frame->setFrameShape(QFrame::Shape::StyledPanel);
        frame->setFrameShadow(QFrame::Shadow::Raised);
        textEdit = new QTextEdit(frame);
        textEdit->setObjectName("textEdit");
        textEdit->setGeometry(QRect(70, 240, 1011, 151));
        gridLayoutWidget = new QWidget(frame);
        gridLayoutWidget->setObjectName("gridLayoutWidget");
        gridLayoutWidget->setGeometry(QRect(50, 420, 1041, 177));
        ...
        gridLayout->addWidget(pushButton_31, 1, 3, 1, 1);

        pushButton_22 = new QPushButton(gridLayoutWidget);
        pushButton_22->setObjectName("pushButton_22");

        gridLayout->addWidget(pushButton_22, 0, 6, 1, 1);
        ...
        gridLayout->addWidget(pushButton_8, 3, 13, 1, 1);

        pushButton_26 = new QPushButton(gridLayoutWidget);
        pushButton_26->setObjectName("pushButton_26");

        gridLayout->addWidget(pushButton_26, 0, 7, 1, 1);
        ...
        gridLayout->addWidget(pushButton_27, 0, 9, 1, 1);
        ...
        gridLayout->addWidget(pushButton_51, 3, 11, 1, 1);
        ...
        gridLayout->addWidget(pushButton_39, 2, 9, 1, 1);
